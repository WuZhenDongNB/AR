...
*/
NSString* key = @"IHSj9KyZ0yzRaj13ZIxAhiGYtjyIxN0fZGFw0OcYznXx2gDBciGtFiRLXafPBMnBwVcYRiCByDKw9pJRMcxW3tMTWBkYGrLIOeSc015bb7187f2f7b0dfb8802b78c5a6754CHOBgHLp8wfihl4HHhKNigdUCbuGOlpGlmmiwSkWaOfehf9BNqxdLPb4eDd4Ln0ok93f";
...
- (void)start{
    ar.initCamera();
    NSArray *imageArray = [[SaveImageTool DefaultSaveImage]GetImagesWithKey:self.imageKey];
